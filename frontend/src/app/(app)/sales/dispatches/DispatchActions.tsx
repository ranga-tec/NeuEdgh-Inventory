...
export function DispatchActions({ dispatchId, canPost }: { dispatchId: string; canPost: boolean }) {
  ...
  async function post() {
    ...
    setBusy(true);
    try {
      await apiPostNoContent(`sales/dispatches/${dispatchId}/post`, {});
      router.refresh();
    } catch (err) {
